...
public class UpdateVersions extends Thread {
    ...
    private static final List<VersionsListener> listeners = new ArrayList<>();
    ...
    public void run() {
        ...
        try {
            ...
            final List<Version> incorrectVersions = new ArrayList<>();
    ...
    public static void addListener(final VersionsListener listener) {
        listeners.add(listener);
    }

    public interface VersionsListener {

        void onVersionsCheckBegin();

        void onVersionsReceived(final VersionsResult result);
