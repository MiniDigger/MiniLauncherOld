...
public class GameTasks extends Thread {
    ...
    private static final List<GameTasksListener> listeners = new ArrayList<>();
    ...
    public void run() {
        ...
        try {
            ...
            final List<String> librariesPaths = new ArrayList<>();
    ...
    private List<String> getMinecraftArgs(final Game game, final User user, final Gson gson, final File assetsDir, final File assetsObjectsDir) {
        ...
        final List<String> args = new ArrayList<>(Arrays.asList(game.minecraftArguments.split(" ")));
        final HashMap<String, List<String>> properties = new HashMap<>();
    ...
    private void initializeGuiComponents(final String fileName) {
    ...
    public static void addListener(final GameTasksListener listener) {
        listeners.add(listener);
    }

    public interface GameTasksListener {

        void onGameTasksBegin();

        void onGameTasksFinished(final boolean success, final LauncherProfile profile);
